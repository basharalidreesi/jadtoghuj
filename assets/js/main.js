        ...
        carousel: {
                ...
                activateCpScroll: function() {
                        jad.lexicon.carouselLeft.addEventListener("click", () => {
                                jad.lexicon.carousel.scrollLeft = jad.carousel.currentIntersection.previousElementSibling.offsetLeft + 15 - (window.innerWidth / 2);
                        });
                        jad.lexicon.carouselRight.addEventListener("click", () => {
                                jad.lexicon.carousel.scrollLeft = jad.carousel.currentIntersection.nextElementSibling.offsetLeft + 15 - (window.innerWidth / 2);
                        });
                },
